...
function SecondResMenu({ resData }) {
  ...
  return (
    <div className="bg-white rounded-lg shadow-md hover:shadow-xl transition-shadow duration-300 p-4 flex flex-col w-72 sm:w-72 md:w-72 lg:w-72 flex-shrink-0">
  {/* Restaurant Image */}
  <img
